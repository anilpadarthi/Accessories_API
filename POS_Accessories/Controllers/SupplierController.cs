...
namespace POS_Accessories.Controllers
{
    ...
    public class SupplierController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(SupplierRequestModel request)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(SupplierRequestModel request)
        {
        ...
        public async Task<IActionResult> UpdateStatus(SupplierRequestModel request)
        {
            var result = await _service.UpdateStatusAsync(request.SupplierId, request.Status);
            return Json(result);
        }
    }
}
